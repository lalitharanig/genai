...
async function sendToAI(message: string, conversation: string[]): Promise<string> {
  try {
...
export default function ChatPage() {
  ...
  const handleSendMessage = async () => {
    ...
    // Format conversation history as array of strings: "user: message" or "bot: message"
    const conversationHistory = [
      ...messages,
      { text: inputMessage, sender: 'user' as 'user' | 'bot' }
    ...
    const botText = await sendToAI(inputMessage, conversationHistory);
  ...
  return (
    <div className="relative min-h-screen bg-[#F0F2F5] flex flex-col justify-end">
      <div
        className="w-full max-w-2xl mx-auto pb-8"
      >
        <div className="flex flex-col justify-center items-center w-full">
          <div className="h-[400px] overflow-y-auto px-4 py-6 bg-white rounded-t-lg shadow-lg flex flex-col justify-end w-full">
